...
const Channels = ({ user }: ChannelProps) => {
    ...
    const selectedChannelFullInfo = useMainStore((state: MainState) => state.selectedChannelFullInfo);
    const fetchchannelFullInfo = useMainStore((state: MainState) => state.fetchChannelInfo);
    const fetchUpdatedChannels = useMainStore((state: MainState) => state.fetchUpdatedChannels);
    ...
    return (
        <section className={styles.channels}>
            ...
            <Dialog open={openShowChannelInfo} onClose={showChannelInfoDialogClose_handler}>
                <DialogTitle>
                    Channel info
                </DialogTitle>
                <DialogContent>
                ...
                <DialogActions>
                    <Button onClick={showChannelInfoDialogClose_handler}>Закрыть</Button>
                </DialogActions>
            </Dialog>
